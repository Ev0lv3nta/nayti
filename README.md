...
[Корпус оценки](evaluation/README.md) содержит 180 безопасных изображений и 116 запросов; baseline/final пока не измерены. Не заявляем универсальную точность или скорость. Скриншоты будут сняты с актуальной сборки на собственных синтетических документах, без личной галереи и без подмены интерфейса макетами.
