...
- Для нового commit нет E2E baseline/final. Подготовленные 180 изображений / 116 запросов не являются измерением; COCO object labels не покрывают все сцены/действия и слабые визуальные совпадения.
