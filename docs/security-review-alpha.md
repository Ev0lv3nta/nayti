...
До personal alpha остаются synthetic scale/resource rehearsal, полная emulator matrix, финальные checksums/runbooks и проверка на Galaxy S23+. Production signing, Google Play policy и публичное распространение model pack в этот review не входят.
