...
- [Начальный baseline на c90ba3e](../evaluation/baseline-2026-09-08.md) выполнен, final после изменений ещё нет. В baseline выявлены слабые визуальные совпадения и 2 промаха pHash на development; универсальные пороги по малой выборке не подбирались. COCO object labels не покрывают все сцены/действия.
