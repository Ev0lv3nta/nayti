...
[Корпус оценки](evaluation/README.md) содержит 180 безопасных изображений и 118 запросов; [начальный baseline](evaluation/baseline-2026-09-08.md) выполнен, final comparison и измерения телефона впереди. Не заявляем универсальную точность или скорость. Скриншоты будут сняты с актуальной сборки на собственных синтетических документах, без личной галереи и без подмены интерфейса макетами.
