...
Реализованы MediaStore catalog, Selected Photos Access, подписанные model packs, возобновляемая индексация, OCR/FTS/USER2/SigLIP2/pHash retrieval, гибридное ранжирование и продуктовый Compose UI. До personal alpha остаются полный security/resource rehearsal, release-like артефакты и приёмка на Galaxy S23+.
